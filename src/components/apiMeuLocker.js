...
module.exports = class MeuLockerAPI {

  constructor() {

  }

  // function connectAPI() {// método para estabelecer conexão com a api
  //   return;
  // }

  // function disconnectAPI(){// método para desconectar a api
  //   return;
  // }
  ...
  *****************************************************************************************************************************/
  ...
  async getUser(celular) {

    try{

      const resposta = {
        nome: "Artur Kazuo P G Fuzikawa"
      }
  ...
  async getCondominioByUser(celular) {
  ...
  *****************************************************************************************************************************/
  ...
  async sendUpdateCadastro(results){

    let bool = true

    try{

      //mandar os results para a api
