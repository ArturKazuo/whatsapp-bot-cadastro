...
//Start:  PORT=3001 node file.js




const SESSION_NAME = 'Pharmakos';
const API_PORT = process.env.APIPORT || 60009;
const WS_PORT = process.env.PORT || 3001;
const SESSION_FILE_PATH = `./session${SESSION_NAME}.json`;
...
const config = {
  ws_url: `ws://localhost:${WS_PORT}`, //(location.protocol === 'https:' ? 'wss' : 'ws') + '://' + location.host,
